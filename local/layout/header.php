    ...
    <header>
        <div class="container">
            ...
            <div class="auth-controller">
                <div class="reg icon js-header-icon">
                    <a href="javascript:void(0)" title="Регистрация"><i class="fas fa-user-plus"></i></a>
                    <div class="dropdown js-dropdown">

                    </div>
                </div>
                <div class="login icon js-header-icon"><a href="javascript:void(0)" title="Войти"><i class="fas fa-sign-in-alt"></i></a></div>
                <div class="authorized icon js-header-icon"><a href="javascript:void(0)" title="Личный кабинет"><i class="fas fa-user"></i></a></div>
